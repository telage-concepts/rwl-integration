...
namespace EdtechSim.Migrations
{
    ...
    [Migration("20240623215410_PrettySureIChangedSomething")]
    partial class PrettySureIChangedSomething
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.EdTech.Domain.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.EdTech.Domain.Entities.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Core.EdTech.Domain.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Core.EdTech.Domain.Entities.Identity.ApplicationUser", null)
                        .WithMany()
